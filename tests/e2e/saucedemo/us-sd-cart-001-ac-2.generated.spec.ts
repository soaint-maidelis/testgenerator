...
test("@user-story @cart [US-SD-CART-001-AC-2] shopping cart - criterion 2", async ({ session, loginPage, inventoryPage, cartPage }) => {
  test.info().annotations.push({ type: 'caseId', description: "US-SD-CART-001-AC-2" });
