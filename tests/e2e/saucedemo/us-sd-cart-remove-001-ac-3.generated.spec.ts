...
test("@user-story @cart [US-SD-CART-REMOVE-001-AC-3] eliminar producto del carrito - criterion 3", async ({ session, loginPage, inventoryPage, cartPage }) => {
  test.info().annotations.push({ type: 'caseId', description: "US-SD-CART-REMOVE-001-AC-3" });
