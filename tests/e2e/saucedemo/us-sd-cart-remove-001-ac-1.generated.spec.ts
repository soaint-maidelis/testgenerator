...
test("@user-story @cart [US-SD-CART-REMOVE-001-AC-1] eliminar producto del carrito - criterion 1", async ({ session, loginPage, inventoryPage, cartPage }) => {
  test.info().annotations.push({ type: 'caseId', description: "US-SD-CART-REMOVE-001-AC-1" });
